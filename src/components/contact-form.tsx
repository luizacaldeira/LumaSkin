    ...
    return(
        <div>
            <form className="flex flex-col gap-0 w-full">
                ...
                <button 
                className="bg-[#493a64bd] text-[#F1EDF9] font-radley italic text-sm sm:text-base md:text-lg lg:text-xl px-2 py-1 sm:px-2.5 sm:py-1 md:px-4 md:py-1 rounded-md cursor-pointer hover:bg-[#312742] hover:scale-101 transition-all duration-300 ease-in-out shadow-sm hover:shadow-md w-full mt-2"
